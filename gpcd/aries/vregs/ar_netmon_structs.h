/******************************************************************************
 * COPYRIGHT CRAY INC. ar_netmon_structs.h
 * FILE: ar_netmon_structs.h
 * Created by v2h.c on Wed Oct  8 14:39:01 2014
 ******************************************************************************/

#ifndef _AR_NETMON_STRUCTS_H_
#define _AR_NETMON_STRUCTS_H_

/*
 *  ARIES NETMON STRUCTURES
 */
typedef union ar_nic_netmon_dbg_lm_t0_cmp_lo_desc {
    struct {
        // QW0
        uint64_t data                     ;	/* Trigger 0 Compare Values 63:0 */
    };
    uint64_t qwords[1];
} ar_nic_netmon_dbg_lm_t0_cmp_lo_desc_t;

typedef union ar_nic_netmon_dbg_lm_t0_cmp_mid_desc {
    struct {
        // QW0
        uint64_t data                     ;	/* Trigger 0 Compare Values 127:64 */
    };
    uint64_t qwords[1];
} ar_nic_netmon_dbg_lm_t0_cmp_mid_desc_t;

typedef union ar_nic_netmon_dbg_lm_t0_cmp_hi_desc {
    struct {
        // QW0
    ...
    uint64_t qwords[1];
} ar_nic_netmon_dbg_lm_t0_cmp_hi_desc_t;

typedef union ar_nic_netmon_dbg_lm_t0_mode_desc {
    struct {
        // QW0
    ...
    uint64_t qwords[1];
} ar_nic_netmon_dbg_lm_t0_mode_desc_t;

typedef union ar_nic_netmon_dbg_lm_t0_mask_lo_desc {
    struct {
        // QW0
        uint64_t data                     ;	/* Trigger 0 Ignore Mask Values 63:0 */
    };
    uint64_t qwords[1];
} ar_nic_netmon_dbg_lm_t0_mask_lo_desc_t;

typedef union ar_nic_netmon_dbg_lm_t0_mask_mid_desc {
    struct {
        // QW0
        uint64_t data                     ;	/* Trigger 0 Ignore Mask Values 127:64 */
    };
    uint64_t qwords[1];
} ar_nic_netmon_dbg_lm_t0_mask_mid_desc_t;

typedef union ar_nic_netmon_dbg_lm_t0_mask_hi_desc {
    struct {
        // QW0
    ...
    uint64_t qwords[1];
} ar_nic_netmon_dbg_lm_t0_mask_hi_desc_t;

typedef union ar_nic_netmon_dbg_lm_t1_cmp_lo_desc {
    struct {
        // QW0
        uint64_t data                     ;	/* Trigger 1 Compare Values 63:0 */
    };
    uint64_t qwords[1];
} ar_nic_netmon_dbg_lm_t1_cmp_lo_desc_t;

typedef union ar_nic_netmon_dbg_lm_t1_cmp_mid_desc {
    struct {
        // QW0
        uint64_t data                     ;	/* Trigger 1 Compare Values 127:64 */
    };
    uint64_t qwords[1];
} ar_nic_netmon_dbg_lm_t1_cmp_mid_desc_t;

typedef union ar_nic_netmon_dbg_lm_t1_cmp_hi_desc {
    struct {
        // QW0
    ...
    uint64_t qwords[1];
} ar_nic_netmon_dbg_lm_t1_cmp_hi_desc_t;

typedef union ar_nic_netmon_dbg_lm_t1_mode_desc {
    struct {
        // QW0
    ...
    uint64_t qwords[1];
} ar_nic_netmon_dbg_lm_t1_mode_desc_t;

typedef union ar_nic_netmon_dbg_lm_t1_mask_lo_desc {
    struct {
        // QW0
        uint64_t data                     ;	/* Trigger 1 Ignore Mask Values 63:0 */
    };
    uint64_t qwords[1];
} ar_nic_netmon_dbg_lm_t1_mask_lo_desc_t;

typedef union ar_nic_netmon_dbg_lm_t1_mask_mid_desc {
    struct {
        // QW0
        uint64_t data                     ;	/* Trigger 1 Ignore Mask Values 127:64 */
    };
    uint64_t qwords[1];
} ar_nic_netmon_dbg_lm_t1_mask_mid_desc_t;

typedef union ar_nic_netmon_dbg_lm_t1_mask_hi_desc {
    struct {
        // QW0
    ...
    uint64_t qwords[1];
} ar_nic_netmon_dbg_lm_t1_mask_hi_desc_t;

typedef union ar_nic_netmon_dbg_lm_mux_sel_desc {
    struct {
        // QW0
    ...
    uint64_t qwords[1];
} ar_nic_netmon_dbg_lm_mux_sel_desc_t;

typedef union ar_nic_netmon_dbg_lm_blk_sel_desc {
    struct {
        // QW0
    ...
    uint64_t qwords[1];
} ar_nic_netmon_dbg_lm_blk_sel_desc_t;

typedef union ar_nic_netmon_err_flg_desc {
    struct {
        // QW0
    ...
    uint64_t qwords[1];
} ar_nic_netmon_err_flg_desc_t;

typedef union ar_nic_netmon_err_clr_desc {
    struct {
        // QW0
        uint64_t diag_only                : 1;	/* Reserved for diagnostics */
        uint64_t cntr_rollover            : 1;	/* An event counter rolled over */
    ...
    uint64_t qwords[1];
} ar_nic_netmon_err_clr_desc_t;

typedef union ar_nic_netmon_err_hss_msk_desc {
    struct {
        // QW0
    ...
    uint64_t qwords[1];
} ar_nic_netmon_err_hss_msk_desc_t;

typedef union ar_nic_netmon_err_os_msk_desc {
    struct {
        // QW0
        uint64_t diag_only                : 1;	/* 0:0 */
        uint64_t cntr_rollover            : 1;	/* 1:1 */
    ...
    uint64_t qwords[1];
} ar_nic_netmon_err_os_msk_desc_t;

typedef union ar_nic_netmon_err_first_flg_desc {
    struct {
        // QW0
        uint64_t diag_only                : 1;	/* 0:0 */
        uint64_t cntr_rollover            : 1;	/* 1:1 */
    ...
    uint64_t qwords[1];
} ar_nic_netmon_err_first_flg_desc_t;

typedef union ar_nic_netmon_dbg_errinj_cntr_perr_desc {
    struct {
        // QW0
    ...
    uint64_t qwords[1];
} ar_nic_netmon_dbg_errinj_cntr_perr_desc_t;

typedef union ar_nic_netmon_err_info_cntr_perr_desc {
    struct {
        // QW0
    ...
    uint64_t qwords[1];
} ar_nic_netmon_err_info_cntr_perr_desc_t;

typedef union ar_nic_netmon_err_info_cntr_perr_cnt_desc {
    struct {
        // QW0
        uint64_t perr_count               ;	/* Number of parity errors that have occurred */
    };
    uint64_t qwords[1];
} ar_nic_netmon_err_info_cntr_perr_cnt_desc_t;

typedef union ar_nic_netmon_prf_event_cntr_ctrl_desc {
    struct {
        // QW0
    ...
    uint64_t qwords[1];
} ar_nic_netmon_prf_event_cntr_ctrl_desc_t;

typedef union ar_nic_netmon_prf_event_cntr_desc {
    struct {
        // QW0
        uint64_t cnt                      ;	/* Event counters */
    };
    uint64_t qwords[1];
} ar_nic_netmon_prf_event_cntr_desc_t;
